...
/*  overloading : asiri yukleme
        ...
        topla(5,8); // Iki int'in toplami : 13             -1-
        topla('a','b'); // Iki char'in toplami : 195        -2-
        topla(3.4 ,5); // double ve int'in toplami : 8.4        -3-
        topla(5,2.1); // int ve double'in toplami : 7.1         -3-
    }
    public static void topla(int sayi1, int sayi2){
        System.out.println("Iki int'in toplami : " +(sayi1+sayi2));
    }
    public static void topla(int a, int b,int c){         // -1-
        System.out.println("uc int'in toplami : " +(a+b+c));
    }
    public static void topla(char char1, char char2){       // -2-
        System.out.println("Iki char'in toplami : " +(char1+char2));
    }
    public static void topla(int sayi1, double sayi2){          //-3-
        System.out.println("int ve double'in toplami : " +(sayi1+sayi2));
    }
    public static void topla(double sayi1, int sayi2){              //-3-
