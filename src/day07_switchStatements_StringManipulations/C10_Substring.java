...
public class C10_Substring {
    public static void main(String[] args) {
      ...
      //Sadece Candir kismini yazdiralim
        ...
        // Eger sadece 1 harf almak isterseniz substring(harfinIndexi , harfinIndex+1)

        System.out.println(str.substring(5,5)); //hiclik
        //System.out.println(str.substring(8,5)); //StringIndexOutOfBoundsException hatasi verir
